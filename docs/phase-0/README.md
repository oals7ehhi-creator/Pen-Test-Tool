...
| 01 | [Requirements](01-requirements.md) | 71 functional + 37 non-functional requirements (traceable IDs, per-phase ownership) |
...
| 05 | [Safety invariants](05-safety-invariants.md) | 65 absolute, test-enforced safety properties (release fails if any is violated) |
...
| 08 | [Design review & critique resolution](08-design-review-and-critique-resolution.md) | Adversarial review (4 rounds); every finding/blocker → resolution with traceability |
